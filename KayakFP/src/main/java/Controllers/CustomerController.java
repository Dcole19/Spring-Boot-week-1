...
@OpenAPIDefinition(info = @Info(title = "Kayak Customer Service"), servers = {
  ...
  @Operation(
      ...
      parameters = {
          @Parameter(
              ...
              required = false, 
              description = "The customer Id (i.e., '32')"), 
          @Parameter(
              name = "customerId",
              allowEmptyValue = false,
              required = false,
  ...
  @Operation(
      ...
      parameters = {
          ...
          @Parameter(
              ...
              allowEmptyValue = false,
              required = false,
              description = "The first name (i.e., 'Indiana')"),
          @Parameter(
              name = "lastName",
              allowEmptyValue = false,
              required = false,
              description = "The last name (i.e., 'Jones')"),
          @Parameter(
              name = "phone",
              allowEmptyValue = false,
              required = false,
              description = "The phone number (i.e., '5055557653')")
      }
  )
