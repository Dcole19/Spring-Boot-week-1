...
public class DefaultCustomerService implements CustomerService{
  ...
  public List<Customers> fetchCustomers(Long customerPK, String customerId){
    log.info("The fetchCustomers method was called with customerPL={}, customerId={}",
  ...
  @Override
  public Optional<Customers> createCustomers(String customerId, String firstName, String lastName, String phone){
    
    log.info("The createCustomers method was called was called with customerId={},"
